...
#include <stdlib.h>
#include <string.h>
#define SERVER_IP_ADDR "6d0b68dbef.st1.iotda-device.cn-north-4.myhuaweicloud.com" // 接入地址
#define SERVER_IP_PORT 1883                                                       // 端口号
#define CLIENT_ID "68640e4b32771f177b47ca6c_WS63_SmartLamp_dev_0_0_2025070116"                                   // 设备id

#define MQTT_CMDTOPIC_SUB "$oc/devices/68640e4b32771f177b47ca6c_WS63_SmartLamp_dev/sys/commands/#" // 平台下发命令

#define MQTT_DATATOPIC_PUB "$oc/devices/68640e4b32771f177b47ca6c_WS63_SmartLamp_dev/sys/properties/report"                 // 属性上报topic
#define MQTT_CLIENT_RESPONSE "$oc/devices/68640e4b32771f177b47ca6c_WS63_SmartLamp_dev/sys/commands/response/request_id=%s" // 命令响应topic
